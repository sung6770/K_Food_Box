...
class _TestScreenState extends State<TestScreen> {
  ...
  Future<void> fetchFood(int foodId) async {
    try {
      final response =
          await http.get(Uri.parse('http://43.201.164.78:8080/foods/$foodId'));
  ...
  Future<void> fetchFoodCategory(int categoryId) async {
    final response = await http.get(
        Uri.parse('http://43.201.164.78:8080/food-categories/$categoryId'));
  ...
  Future<void> fetchAllFoodCategories() async {
    final response =
        await http.get(Uri.parse('http://43.201.164.78:8080/food-categories'));
  ...
  Future<void> fetchFoodsByCategory(int categoryId) async {
    final response = await http.get(Uri.parse(
        'http://43.201.164.78:8080/food-categories/$categoryId/foods'));
